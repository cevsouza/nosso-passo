...
function ParentDashboardContent() {
  ...
  // Editor extraido em <StepsEditor> (compartilhado com o portal do Profissional).
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              ...
                              <div className="md:col-span-2">
                                ...
                                <div className="mt-3">
                                  ...
                                  <StepsEditor steps={taskSteps} setSteps={setTaskSteps} title={title} locale={locale} onBubble={playBubble} />
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 border-t border-slate-200/60 pt-3">
                                        ...
                                        <div className="md:col-span-2">
                                          ...
                                          <div className="mt-3">
                                            ...
                                            <StepsEditor steps={editTaskSteps} setSteps={setEditTaskSteps} title={editTaskTitle} locale={locale} onBubble={playBubble} />
