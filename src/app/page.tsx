...
const localDict = {
  pt: {
    ...
    planFreeFeatures: ["Rotina visual diária", "Até 5 tarefas por dia", "Níveis de interface Foco e Intermediário", "Modo calma e comunicação por figuras"],
  ...
  es: {
    ...
    planFreeFeatures: ["Rutina visual diaria", "Hasta 5 tareas por día", "Niveles de interfaz Foco e Intermedio", "Modo calma y comunicación por figuras"],
  ...
  en: {
    ...
    planFreeFeatures: ["Daily visual routine", "Up to 5 tasks a day", "Focus and Intermediate interface levels", "Calm mode and picture communication"],
